...
sharp — probably sharper than the data itself justifies on its own.

A few things worth flagging before the narrative fully sets:

- One print doesn't make a trend. The three-month average still matters more
  than today's headline number.
- The sectors that moved the most today are the same ones that have been
  trading on rate expectations all year, which means today's move says more
